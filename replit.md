...
- **E3DC Modbus-Seite (Frontend Design Phase):** Neue dedizierte E3DC-Seite mit Energieflussdiagramm hinzugefügt - zeigt PV-Leistung, Batterie-Status, Hausverbrauch, Netzleistung, Autarkie und Eigenverbrauch. BottomNav um "E3DC" Tab erweitert. Derzeit mit Mock-Daten (Backend-Modbus-Integration folgt in Phase 2). E3DC IP-Adresse in Settings konfigurierbar.
